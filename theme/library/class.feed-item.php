 ...
 */
 ...
 class FeedItem
 {
    ...
    */
    ...
    {
        $key = $elementName;
        while (is_array($this->elements[$key])) //get a unique key
        {
            $key .= '_alt';
        } 
        $this->elements[$key]['name']       = str_replace('_alt', '', $elementName);
    ...
    public function addElementArray($elementArray)
    {
        ...
        foreach ($elementArray as $elementName => $content) 
        {
            if(is_array($content))
            {
                ...
                {
                    $this->addElement($elementName, $content['content'], $content['attributes']);
                }
                else 
                {
